...
const ErrorPage = () => {
	...
	<div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
		<div className="max-w-md text-center">
			...
			<Link to={'/'} rel="noopener noreferrer" href="#" className="px-8 py-3 font-semibold rounded bg-violet-400 dark:bg-[#2c8cf3] text-gray-900 dark:text-gray-50">Back to homepage</Link>
		</div>
	</div>
</section>
    );
