...
const About = () => {
	return (
		<div>
			<Helmet>
				<title>About-VacationBliss</title>
			</Helmet>
			<div className=" mt-9 mx-auto space-y-12">
				<article className="space-y-8 rounded-md dark:bg-gray-100 dark:text-gray-600 p-6">
					<div className="space-y-6">


						<div className="flex flex-col lg:flex-row justify-between">
							<div>
							<p className="md:text-6xl lg:mt-28 text-2xl text-center ">
								Welcome To  <span className="text-blue-700 font-bold">VacationBliss</span>
							</p>
							</div>
							<div>
						...
						<div className="grid md:p-5">
							...
							<p>
								At Our Estate, we believe that every individual deserves to find their perfect home, and we are dedicated to making that dream a reality. With years of experience in the real estate industry, Our Estate has established itself as a trusted name in property management, offering a diverse portfolio of homes and unparalleled customer service.
								At Our Estate, we believe that every individual deserves to find their perfect home, and we are dedicated to making that dream a reality. With years of experience in the real estate industry, Our Estate has established itself as a trusted name in property management, offering a diverse portfolio of homes and unparalleled customer service.
							</p>
							<h1 className="text-xl font-extrabold mt-5">Our Mission
							</h1>
							<p>
								Our mission at Our Estate is to provide exceptional living experiences by offering top-quality properties and unparalleled service to our clients. We strive to exceed expectations and create lasting relationships with our residents, tenants, and property owners.
							</p>

							<h1 className="text-xl font-extrabold mt-5">What Sets Us Apart</h1>
							<p>
								At Our Estate, we stand out from the crowd with our commitment to excellence in every aspect of our business. From our meticulously curated selection of properties to our dedicated team of professionals, we go above and beyond to ensure the satisfaction of our clients. With Our Estate, you can expect nothing less than the best.
							</p>

							<h1 className="text-xl font-extrabold mt-5">Services We Offer</h1>
							
								<li><span className="font-semibold">Property Management:</span> Our experienced team handles every aspect of property management, from tenant screening and leasing to maintenance and accounting, ensuring a hassle-free experience for property owners.</li>
								<li><span className="font-semibold">Rental Services:</span> Whether you are looking for a new home or seeking tenants for your property, Our Estate offers comprehensive rental services to meet your needs.</li>
								<li><span className="font-semibold">Sales and Acquisitions:</span> From buying and selling homes to property investments, Our Estate provides expert guidance and support throughout the process.</li>
								<li>
									<span className="font-semibold">Customer Support:</span> Our dedicated customer support team is available to assist you with any inquiries or concerns, ensuring a smooth and seamless experience.
								</li>
							

							<h1 className="text-xl font-extrabold mt-5">Get in Touch</h1>


							<p>Ready to find your dream home or explore property management options? Contact Our Estate today to learn more about our services and how we can help you achieve your real estate goals.</p>
			...
			<section className="p-6  dark:text-gray-800">
				<div className="container p-4 mx-auto text-center">
					<h2 className="text-4xl font-bold mb-7">Trusted by the industry leaders</h2>
				</div>
