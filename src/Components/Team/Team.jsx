...
const Team = () => {
    return (
        <section className="py-6 mt-9  dark:text-gray-800">
	<div className="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
		<h1 className="text-2xl font-bold leading-none text-center sm:text-5xl">Meet Our team</h1>
		<p className="max-w-2xl text-center dark:text-gray-600">Meet our dynamic team of diverse talents, dedicated to innovation and excellence. Together, we collaborate, create, and conquer challenges, driving success and forging a brighter future.</p>
